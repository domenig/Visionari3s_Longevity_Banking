...
portfolio_1_df = call_update_data(tickers=tickers_portfolio_1, OHLC_df_file = './csv/'+ "portfolio_1.csv")
portfolio_2_df = call_update_data(tickers=tickers_portfolio_2, OHLC_df_file = './csv/'+ "portfolio_2.csv")
portfolio_3_df = call_update_data(tickers=tickers_portfolio_3, OHLC_df_file = './csv/'+ "portfolio_3.csv")
portfolio_4_df = call_update_data(tickers=tickers_portfolio_4, OHLC_df_file = './csv/'+ "portfolio_4.csv")
portfolio_5_df = call_update_data(tickers=tickers_portfolio_5, OHLC_df_file = './csv/'+ "portfolio_5.csv")
portfolio_6_df = call_update_data(tickers=tickers_portfolio_6, OHLC_df_file = './csv/'+ "portfolio_6.csv")
portfolio_7_df = call_update_data(tickers=tickers_portfolio_7, OHLC_df_file = './csv/'+ "portfolio_7.csv")
portfolio_8_df = call_update_data(tickers=tickers_portfolio_8, OHLC_df_file = './csv/'+ "portfolio_8.csv")
portfolio_9_df = call_update_data(tickers=tickers_portfolio_9, OHLC_df_file = './csv/'+ "portfolio_9.csv")
portfolio_10_df = call_update_data(tickers=tickers_portfolio_10, OHLC_df_file = './csv/'+ "portfolio_10.csv")
